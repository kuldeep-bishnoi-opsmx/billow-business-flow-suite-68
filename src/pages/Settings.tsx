...
import { InvoiceFormatSelector } from '@/components/InvoiceFormats/InvoiceFormats';
import {
...
const Settings = () => {
  ...
  const [selectedInvoiceFormat, setSelectedInvoiceFormat] = useState('classic');
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>GST Return Alerts</Label>
                    <p className="text-sm text-muted-foreground">GST filing deadline reminders</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
        ...
        <TabsContent value="invoicing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure your invoice format and preferences</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <InvoiceFormatSelector
                selectedFormat={selectedInvoiceFormat}
                onFormatChange={setSelectedInvoiceFormat}
              />
